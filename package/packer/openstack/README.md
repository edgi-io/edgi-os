# EDGI Packer OpenStack image

These are templates for building a EDGI [OpenStack](https://openstack.org) image for both AMD64 and ARM64 using [Packer](https://www.packer.io).
...
| image                       | EDGI-v0.10.3-amd64 (398801c7-eaa8-46d1-bee2-e53f60b64c3b) |
| key_name                    | Deadline                                                  |
| name                        | edgi-test                                                 |
...
$ openstack server add floating ip edgi-test 193.16.42.77

$ ssh edgi@193.16.42.77
